...
function CssAnimation(props) {
  ...
  const hasExited = React57.useRef(true);
  React57.useEffect(() => {
    if (requestedEnter && hasExited.current) {
      hasExited.current = false;
    }
  }, [requestedEnter]);
  const handleAnimationEnd = React57.useCallback((event) => {
...
var CssTransition = React58.forwardRef(function CssTransition2(props, forwardedRef) {
  const {
    children,
    className,
  ...
  const [isEntering, setIsEntering] = React58.useState(false);
  React58.useEffect(() => {
    if (requestedEnter) {
  ...
  const handleTransitionEnd = React58.useCallback((event) => {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-PEQRPGGB.js.map
