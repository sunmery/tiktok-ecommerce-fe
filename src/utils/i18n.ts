...
const resources = {
    ...
    zh: {
        translation: {
            ...
            'common.error': '操作失败',
            'common.noData': '暂无数据',
            'common.noResults': '没有找到相关结果',
            'common.noMore': '没有更多数据了',
            'common.tryAgainLater': '稍后重试',
            ...
            'common.confirmClear': '您确定要清空吗？',
            'common.confirmSave': '您确定要保存吗？',
            'common.confirmUpload': '您确定要上传吗？',
            'common.confirmDownload': '您确定要下载吗？',
            'common.confirmExit': '您确定要退出吗？',
