...
const resources = {
    en: {
        translation: {
            'admin.sensitiveWords.title': 'Sensitive Words',
            ...
            'admin.sensitiveWords.status': 'Status',
            'admin.sensitiveWords.createdAt': 'Created At',
            'admin.sensitiveWords.actions': 'Actions',
            'admin.sensitiveWords.loadError': 'Load Failed',
            'admin.sensitiveWords.noData': 'No Data',
            'admin.sensitiveWords.active': 'Active',
            'admin.sensitiveWords.levelHigh': 'High',
            'admin.sensitiveWords.levelMedium': 'Medium',
            'admin.sensitiveWords.levelLow': 'Low',
            'admin.sensitiveWords.management': 'Word Management',
            'admin.sensitiveWords.configuration': 'Word Configuration',
            'admin.sensitiveWords.monitoring': 'Word Monitoring',
            'admin.sensitiveWords.enter': 'Enter Word Management',
            ...
            'consumer.order.redirectNonConsumer': 'Non-consumer user, redirected to homepage',
            'consumer.order.fetchComplete': 'Order details fetched successfully',
            'consumer.order.error.fetchFailed': 'Failed to fetch order details',
            'consumer.order.log.calculatingItemCost': 'Calculating item cost',
            'consumer.order.log.calculatingTotal': 'Calculating total price',
            'consumer.order.merchantId': 'Merchant ID',
            'consumer.order.subOrderId': 'Sub-order ID',
            'consumer.order.noSubOrder': 'None',
            'consumer.order.shippingStatus': 'Shipping Status',
            'consumer.order.error.noLogistics': 'No sub-order information available, cannot check logistics',
            'consumer.order.viewLogistics': 'View Logistics',
            'consumer.order.deliveryNotice': 'Items have been delivered, please confirm receipt',
            'consumer.order.success.confirmReceived': 'Receipt confirmed successfully',
            'consumer.order.error.confirmReceived': 'Failed to confirm receipt',
            'consumer.order.confirmReceived': 'Confirm Receipt',
            'consumer.orders.payNow': 'Pay Now',
            'consumer.orders.addToCart': 'Add to Cart',
            'consumer.orders.addedToCart': 'Added to cart',
            'order.viewLogistics': 'View Logistics',
            'order.subtotal': 'Subtotal',
            "products.uploadSuccess": "Successfully uploaded {{successCount}}/{{totalCount}} products",
            "products.uploadPartialFailed": "{{failedCount}}/{{totalCount}} products failed to upload",
            "products.uploadFailed": "Batch upload failed, please try again",
            "products.noDataWarning": "Please select data to upload first",
            ...
            'consumer.logistics.basicInfo': 'Logistics Basic Information',
            'consumer.logistics.shippingId': 'Shipping ID',
            'consumer.logistics.orderSubId': 'Order Sub ID',
            'consumer.logistics.shippingStatus': 'Shipping Status',
            'consumer.logistics.trackingNumber': 'Tracking Number',
            'consumer.orders.redirectToLogin': 'Unauthorized user, redirecting to login page',
            'consumer.orders.redirectError': 'Failed to redirect to login page',
            'consumer.orders.queryParams': 'Order query parameters',
            'consumer.orders.fetchError': 'Failed to fetch orders',
            'consumer.logistics.carrier': 'Carrier',
            'consumer.logistics.shippingAddress': 'Shipping Address',
            'consumer.logistics.receiverAddress': 'Receiver Address',
            'consumer.logistics.noShippingInfo': 'Unable to load shipping information',
            'consumer.logistics.route': 'Logistics Route',
            'consumer.logistics.updates': 'Logistics Updates',
            'consumer.logistics.status': 'Status',
            'consumer.logistics.loadingGeocoding': 'Loading location information...',

            'merchant.address.contactPhone': 'Contact Phone',
            'merchant.address.streetAddress': 'Street Address',
            'consumer.orders.searchSuccess': 'Search conditions updated successfully',
            'consumer.orders.searchError': 'Failed to update search conditions',
            'consumer.orders.filterCleared': 'Filter conditions cleared',
            'consumer.orders.clearFilterError': 'Failed to clear filter conditions',
            'merchant.address.city': 'City',
            'merchant.orders.title': 'Order Management',
            'merchant.orders.filterShippingStatus': 'Filter by Shipping Status',
            'merchant.orders.filterPaymentStatus': 'Filter by Payment Status',
            'merchant.orders.listTitle': 'Order List',
            'merchant.orders.loading': 'Loading...',
            'merchant.orders.noData': 'No orders found',
            ...
            'merchant.orders.status.waitCommand': 'Pending',
            ...
            'products.enterAttributeName': 'Please enter attribute name',
            ...
            'merchant.logistics.shippingStatus': 'Shipping Status',

            'consumer.order.fetchFailed': 'Failed to fetch order information',
            'consumer.order.error.fetchDetailFailed': 'Failed to fetch order details',
            'consumer.order.error.fetchDetailRetry': 'Failed to fetch order details, please try again later',
            'consumer.orders.filter.status': 'Order Status',
            'consumer.orders.filter.allStatuses': 'All Statuses',
            'consumer.orders.filter.apply': 'Apply Filters',
            'consumer.orders.error': 'Failed to load orders',
            'consumer.orders.empty': 'No orders found',
            'status.notPaid': 'Not Paid',
            'status.processing': 'Processing',
            'status.paid': 'Paid',
            'status.pendingShipment': 'Pending Shipment',
            'status.shipped': 'Shipped',
            'status.delivered': 'Delivered',
            'order.id': 'Order ID',
            'order.date': 'Order Date',
            'order.subOrders': 'Sub-orders',
            'order.quantity': 'Quantity',
            'order.moreItems': '{count} more items',
            ...
            'merchant.orders.enterCarrier': 'Enter carrier name',
            ...
            'logisticsMap.error.fetchRouteFailed': 'Failed to fetch route data',
            'logisticsMap.error.invalidRouteData': 'Invalid route data',
            'logisticsMap.error.fetchRouteFallback': 'Failed to fetch route: {{errorMsg}}. Using straight path instead.',
            'logisticsMap.popup.sellerLocation': 'Seller Location',
            'logisticsMap.popup.userLocation': 'User Location',
            'logisticsMap.popup.currentLocation': 'Current Location',
            'logisticsMap.loadingPath': 'Loading path...',
            'consumer.logistics.error.fetchShippingInfo': 'Failed to fetch shipping info: {{message}}',
            'consumer.logistics.error.geocodingFailedWithFallback': 'Cannot get address coordinates: {{errorMsg}}. Using default coordinates.',
            'consumer.logistics.success.statusUpdated': 'Shipping status updated: {{status}}',

            'consumer.logistics.title': 'Logistics Tracking',
            'consumer.logistics.orderInfo': 'Order Information',
            'consumer.logistics.subOrderId': 'Sub Order ID',
            'consumer.logistics.estimatedDelivery': 'Estimated Delivery:',
            'consumer.logistics.mapTitle': 'Logistics Map',

            'order.shippingStatus': 'Shipping Status',
            'order.subOrder': 'Sub Order',
    ...
    zh: {
        translation: {
            'order.email:': '收件箱',
            'order.subtotal:': '子订单总计',
            'order.shipping:': '运费',
            'order.shippingAddress:': '物流状态',
            'order.subOrder': '子订单',
            'order.shippingAddress': '收货地址',
            'order.summary': '摘要',
            'order.paymentStatus:': '支付状态',
            'order.totalAmount:': '总价',
            // 在 resources.zh.translation 中添加
            'order.shippingStatus': '物流状态',
            ...
            'products.enterImageUrl': "请输入图片链接",
            'products.or': "或",
            'products.enterAttributeName': '请输入属性名称',
            ...
            'consumer.order.redirectNonConsumer': '非消费者用户，已重定向到首页',
            'consumer.order.fetchComplete': '订单详情获取完成',
            'consumer.order.error.fetchFailed': '获取订单详情失败',
            'consumer.order.log.calculatingItemCost': '计算商品cost',
            'consumer.order.log.calculatingTotal': '计算商品总价total',
            'consumer.order.merchantId': '商家ID',
            'consumer.order.subOrderId': '子订单号',
            'consumer.order.noSubOrder': '暂无',
            'consumer.order.shippingStatus': '配送状态',
            'consumer.order.error.noLogistics': '该订单没有子订单信息，无法查询物流',
            'consumer.order.viewLogistics': '查看物流',
            'consumer.order.deliveryNotice': '商品已送达，请确认收货',
            'consumer.order.success.confirmReceived': '确认收货成功',
            'consumer.order.error.confirmReceived': '确认收货失败',
            'consumer.order.confirmReceived': '确认收货',
            ...
            'merchant.orders.trackingNumber': '物流单号',
            'merchant.orders.enterTrackingNumber': '请输入物流单号',
            'merchant.orders.carrier': '承运商',
            'merchant.orders.enterCarrier': '请输入承运商名称',
            'merchant.orders.estimatedDelivery': '预计送达时间',
            'merchant.orders.shippingFee': '运费',

            'merchant.address.noAddresses': '暂无可用地址',
            'common.loading': '加载中...',


            'orders.shippingInfo': '商品详情',
            ...
            'consumer.order.error.fetchDetailRetry': '获取订单详情失败，请稍后重试',
            'consumer.order.notFound': '未找到订单信息',
            'consumer.order.fetchFailed': '获取订单信息失败',
            'consumer.orders.title': '我的订单',
            'consumer.orders.filter.startDate': '开始日期',
            'consumer.orders.filter.endDate': '结束日期',
            'consumer.orders.filter.status': '订单状态',
            ...
            'order.id': '订单号',
            'order.date': '下单日期',
            'order.subOrders': '子订单数',
            'order.quantity': '数量',
            'order.moreItems': '还有 {count} 个商品',
            'order.totalItems': '商品总数',
            'order.total': '总计',
            'order.details': '订单详情',

            // 订单管理
            'orders.notFound': '未查找到该订单',
            'orders.createdTime': '创建时间',
            'orders.title': '订单',
            ...
            'merchant.orders.status.unknown': '未知状态',
            ...
            'consumer.orders.queryParams': '查询订单参数',
            'consumer.orders.fetchError': '获取订单失败',
            'consumer.orders.searchSuccess': '查询条件更新成功',
            'consumer.orders.searchError': '查询条件更新失败',
            'consumer.orders.filterCleared': '查询条件已清除',
            'consumer.orders.clearFilterError': '清除查询条件失败',
            // 销售分析
            ...
            'consumer.orders.status.notPaid': '未支付',
            'consumer.orders.status.paid': '已支付',
            'consumer.orders.status.shipped': '已发货',
            'consumer.orders.status.delivered': '已送达',
            'consumer.orders.status.cancelled': '已取消',
            'consumer.orders.status.failed': '支付失败',
            'consumer.orders.status.processing': '支付中',
            'consumer.orders.status.waiting': '等待中',
            'consumer.orders.filter.all': '全部',

            'consumer.orders.filter.paymentStatus': '支付状态',
            'consumer.orders.filter.shippingStatus': '物流状态',
            'consumer.orders.filter.search': '搜索',
            ...
            "products.uploadSuccess": "成功上传 {{successCount}}/{{totalCount}} 个商品",
            "products.uploadPartialFailed": "{{failedCount}}/{{totalCount}} 个商品上传失败",
            "products.uploadFailed": "批量上传失败，请重试",
            "products.noDataWarning": "请先选择要上传的数据",

            'order.viewLogistics': '查看物流',
            'order.subtotal': '小计',
            'consumer.orders.addToCart': '加入购物车',
            'consumer.orders.addedToCart': '已添加到购物车',
            ...
            'logisticsMap.error.fetchRouteFailed': '无法获取路径数据',
            'logisticsMap.error.invalidRouteData': '路径数据无效',
            'logisticsMap.error.fetchRouteFallback': '获取路径失败: {{errorMsg}}. 使用直线路径代替。',
            'logisticsMap.popup.sellerLocation': '卖家位置',
            'logisticsMap.popup.userLocation': '用户位置',
            'logisticsMap.popup.currentLocation': '当前位置',
            'logisticsMap.loadingPath': '加载路径中...',
            'consumer.logistics.error.fetchShippingInfo': '获取物流信息失败: {{message}}',
            'consumer.logistics.error.geocodingFailedWithFallback': '无法获取地址坐标: {{errorMsg}}。将使用默认坐标。',
            'consumer.logistics.success.statusUpdated': '物流状态已更新: {{status}}',
            'consumer.logistics.loadingGeocoding': '正在获取地址坐标...',
            'consumer.logistics.title': '物流追踪',
            'consumer.logistics.orderInfo': '订单信息',
            'consumer.logistics.subOrderId': '子订单ID:',
            'consumer.logistics.shippingStatus': '物流状态',
            'consumer.logistics.carrier': '承运商',
            'consumer.logistics.trackingNumber': '物流单号',
            'consumer.logistics.estimatedDelivery': '预计送达',
            'consumer.logistics.shippingAddress': '发货地址',
            'consumer.logistics.receiverAddress': '收货地址',
            'consumer.logistics.mapTitle': '物流地图',
            'consumer.orders.redirectToLogin': '未登录用户，已重定向到登录页',
            'consumer.orders.redirectError': '重定向到登录页失败',
            'consumer.logistics.confirmReceipt': '确认收货',

            'consumer.logistics.basicInfo': '物流基本信息',
            'consumer.logistics.shippingId': '货运单号',
            'consumer.logistics.orderSubId': '商品订单号',

            'consumer.logistics.noShippingInfo': '无法加载物流信息',
            'consumer.logistics.route': '物流路线',
            'consumer.logistics.updates': '物流更新记录',
            'consumer.logistics.status': '状态',

            'admin.sensitiveWords.title': '敏感词管理',
            'admin.sensitiveWords.add': '添加敏感词',
            'admin.sensitiveWords.edit': '编辑敏感词',
            'admin.sensitiveWords.id': 'ID',
            'admin.sensitiveWords.word': '敏感词',
            'admin.sensitiveWords.category': '分类',
            'admin.sensitiveWords.level': '敏感级别',
            'admin.sensitiveWords.status': '状态',
            'admin.sensitiveWords.createdAt': '创建时间',
            'admin.sensitiveWords.actions': '操作',
            'admin.sensitiveWords.loadError': '加载失败',
            'admin.sensitiveWords.noData': '暂无数据',
            'admin.sensitiveWords.active': '启用',
            'admin.sensitiveWords.levelHigh': '高',
            'admin.sensitiveWords.levelMedium': '中',
            'admin.sensitiveWords.levelLow': '低',
            'admin.sensitiveWords.management': '敏感词管理',
            'admin.sensitiveWords.configuration': '敏感词配置',
            'admin.sensitiveWords.monitoring': '敏感词监控',
            'admin.sensitiveWords.enter': '进入敏感词管理',
