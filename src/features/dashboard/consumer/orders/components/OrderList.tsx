...
import {ConsumerOrderItem, MergedOrder} from '../type'
...
export default function OrderList({orders, showPaymentButton = false, showLogisticsButton = false, onPayOrder, onAddToCart}: OrderListProps) {
    ...
    // 处理支付订单
    const handlePayOrder = (e: React.MouseEvent, orderId: number) => {
    ...
    // 处理查看物流
    const handleViewLogistics = (e: React.MouseEvent, subOrderId: number) => {
        e.stopPropagation(); // 阻止事件冒泡
