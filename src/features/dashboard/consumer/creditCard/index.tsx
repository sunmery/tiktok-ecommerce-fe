...
import { useCreateCreditCard, useCreditCards, useDeleteCreditCard } from './hook'
import type { CreditCard as CreditCardType } from './type.ts'
        ...
        <Box sx={{p: 2, maxWidth: '1200px', mx: 'auto'}}>
            ...
            {isLoading ? (
                ...
                <Grid container spacing={2}>
                    {creditCards.map((card: CreditCardType, index: number) => {
                        // 为每张卡片分配不同的背景变体
                        // 使用索引来交替显示不同的背景样式
