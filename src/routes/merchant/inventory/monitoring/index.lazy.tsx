...
import { Box, Typography, Grid, Card, CardContent, Table, Sheet, Alert, CircularProgress, Divider, Button, Tabs, TabList, Tab, TabPanel, List, ListItem, ListItemContent } from '@mui/joy'
import { useSnapshot } from 'valtio/react'
import { userStore } from '@/store/user'
import { inventoryService, LowStockProduct, StockAlert, StockAdjustment } from '@/api/inventoryService'
                            ...
                            <Box sx={{ display: 'flex', alignItems: 'center' }}>
                              {product.imageUrl && (
                                <Box 
                                  ...
                                  sx={{ width: 40, height: 40, mr: 2, objectFit: 'cover', borderRadius: '4px' }}
                                />
                              )}
                              {product.productName}
                            </Box>
