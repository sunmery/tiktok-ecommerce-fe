...
import {Alert, Box, Button, Card, CardContent, Typography} from '@mui/joy'
...
function ConsumerMapView() {
    ...
    const [sellerPosition, ] = useState<Coordinates>([39.9042, 116.4074]) // 北京
    const [userPosition, ] = useState<Coordinates>([31.2304, 121.4737]) // 上海
