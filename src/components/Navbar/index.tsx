import {Badge, Box, IconButton, Input, Sheet, Tooltip, Typography} from '@mui/joy';
import {Link, useNavigate} from '@tanstack/react-router';
import {Person as PersonIcon, Search as SearchIcon, ShoppingCart as ShoppingCartIcon} from '@mui/icons-material';
