                    ...
                    <Box sx={{mt: 2}}>
                        {selectedCard ? (
                            <Box>
                                ...
                                <Typography
                                    level="body-md">有效期: {selectedCard.expMonth}/{selectedCard.expYear}</Typography>
                                {selectedCard.brand &&
                                    <Typography level="body-md">卡种: {selectedCard.brand}</Typography>}
                            </Box>
                        ) : (
                                        ...
                                        >
                                            <Box sx={{display: 'flex', alignItems: 'center'}}>
                                                ...
                                                <Box>
                                                    ...
                                                    <Typography
                                                        level="body-sm">{card.name} - {card.expMonth}/{card.expYear}</Typography>
                                                </Box>
                                            </Box>
                                            <Button
                                                variant="plain"
